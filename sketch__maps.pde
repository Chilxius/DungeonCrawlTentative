...
//---------------------------------------------------------------------------------------------------------------------------\\
  ...
  bossIndex++;
  //In first meadow
  m[mapIndex].tiles[83][35].placeBoss( mapIndex, color(255,0), "Pollen sprays as they emerge from the flowers.", new Monster("Nectarhunter", "Wasp.png", 60, 20, 30, 4, 1, 5, 18, 0, AttackType.WIND), false);
