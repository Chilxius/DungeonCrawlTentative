void setupMaps()
{
  ...
  m[0].tiles[54][4].placeBoss( color(0, 0, 200), "A terrible creature guards the way!", new Monster("Xaxaphar", "BlueMindflair.png", 20, 5, 5, 5, 5, 5, 5, 50, AttackType.HOLY) );
  ...
  m[0].tiles[88][2].placeBoss( color(200, 150, 100), "You've entered a forbidden place...", new Monster("Werewolf", "BrownWerewolf.png", 40, 9, 9, 5, 0, 3, 7, 0, AttackType.FIRE) );
      ...
      zoo.boss[1].attacks[3] = new Attack("rends and tears!", 40, true);
      zoo.boss[1].attacks[4] = new Attack("goes for the jugular!", 75, false);
