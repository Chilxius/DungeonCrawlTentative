...
{ 
  ...
  */
  ...
  //Boat Boss
  m[mapIndex].tiles[54][43].placeBoss( mapIndex, color(#4c585c), "This is the last, and the largest.", new Monster("Deep Ratlord", "abyssBig.png", 150, 18, 10, 4, 10, 4, 15, 0, AttackType.HOLY), false);
